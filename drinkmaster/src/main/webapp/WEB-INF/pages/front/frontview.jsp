                                ...
                                <div class="col mb-5">
                                    <div >
                                        ...
                                        <div class="badge text-white position-absolute"
                                            style="top: 0.5rem; right: 0.5rem"><img alt="" src="<c:url value="/images/top3/top2.png"/>" style="width: 50px;height: 50px;background-color: transparent;" ></div>
                                        <!-- Product image-->
                                        <a href="http://localhost:8081/drinkmaster/front/firm/${top3[1].firmBean.firmId}">
                                        <img  src="<c:url value="/backend/firm/${top3[1].firmBean.firmId}/photo"/>"
                                            alt="..." /></a>
                                        <!-- Product details-->
                                ...
                                <div class="col mb-5">
                                    <div >
                                        ...
                                        <div class="badge text-white position-absolute"
                                            style="top: 0.5rem; right: 0.5rem"><img alt="" src="<c:url value="/images/top3/top2.png"/>" style="width: 50px;height: 50px;background-color: transparent;" ></div>
                                        <!-- Product image-->
                                        <a href="http://localhost:8081/drinkmaster/front/firm/${top3[2].firmBean.firmId}">
                                        <img  src="<c:url value="/backend/firm/${top3[2].firmBean.firmId}/photo"  />"
                                            alt="..." /></a>
                                        <!-- Product details-->
