	...
	<table id="cart" class="table table-hover table-condensed">
    				<thead>
						<tr>
							...
							<th style="width:100px" class="text-center">總金額</th>
					...
					<tbody>
						<tr>
							...
							<td><h6 class="nomargin">珍珠奶茶</h4></td>
							
							<td data-th="Price">$70</td>
							<td data-th="Quantity">
								<input type="number" class="form-control text-center" value="1">
							</td>
							<td data-th="Product">半糖</td>
							<td data-th="Product">冷</td>
...
<!-- 							備註:折扣碼後的價格 -->
							<td class="hidden-xs text-center"><strong>Total $70</strong></td>
							<td><a href="#" class="btn btn-success btn-block">加到購物車&thinsp;<i class="fa fa-angle-right"></i></a></td>
						</tr>
					</tfoot>
				</table>
</div>
